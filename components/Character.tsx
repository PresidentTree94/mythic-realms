...
export default function Character({ data }: { data: Char }) {
  return (
    <div className="relative rounded-xl overflow-hidden aspect-21/32 shadow group">
      ...
      <div className="absolute inset-0 bg-gradient-to-t from-black/90 to-transparent flex flex-col justify-end p-6">
        ...
        <p className="font-body text-secondary italic text-sm border-l-2 border-secondary pl-2">Inspired by {data.inspiration}</p>
      </div>
    </div>
  );
}